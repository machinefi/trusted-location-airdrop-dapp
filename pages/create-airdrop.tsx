    ...
    return (
        <Container>
            ...
            <FormControl isRequired>
                ...
                <Input type='number' placeholder='-41.123456' onChange={(e) => setFormInput({ ...formInput, lat: Number(e.target.value) })} />
                <FormHelperText mb={6} >Enter a value between -90 and 90</FormHelperText>
                <FormLabel>Longitude</FormLabel>
                <Input type='number' placeholder='-12.123456' onChange={(e) => setFormInput({ ...formInput, long: Number(e.target.value) })} />
                <FormHelperText mb={6} >Enter a value between -180 and 180</FormHelperText>
                <FormLabel>Max Distance (meters)</FormLabel>
                <Input type='number' mb={4} placeholder='200' onChange={(e) => setFormInput({ ...formInput, max_distance: Number(e.target.value) })} />

                <FormLabel>Time From</FormLabel>
                <Input type='date' mb={4} onChange={(e) => setFormInput({ ...formInput, time_from: Date.parse(e.target.value) })} />

                <FormLabel>Time To</FormLabel>
                <Input type='date' mb={4} onChange={(e) => setFormInput({ ...formInput, time_to: Date.parse(e.target.value) })} />

                <FormLabel>Tokens Count</FormLabel>
                <Input type='number' placeholder='7' onChange={(e) => {
                    setFormInput({ ...formInput, tokens_count: Number(e.target.value) })
